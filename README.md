![jcenter](https://img.shields.io/badge/_jcenter_-_8.181-6688ff.png?style=flat)
# alpn_boot
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/alpn/8.181/alpn-boot-8.181.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.alpn:alpn-boot:8.181'
}
```
