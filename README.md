![jcenter](https://img.shields.io/badge/_jcenter_-_8.182-6688ff.png?style=flat)
# alpn_boot
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/alpn/8.182/alpn-boot-8.182.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.alpn:alpn-boot:8.182'
}
```
