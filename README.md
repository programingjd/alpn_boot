![jcenter](https://img.shields.io/badge/_jcenter_-_8.202-6688ff.png?style=flat)
# alpn_boot
...
[Download](https://bintray.com/artifact/download/programingjd/maven/info/jdavid/alpn/8.202/alpn-boot-8.202.jar) the latest jar.
...
```
dependencies {
  compile 'info.jdavid.alpn:alpn-boot:8.202'
}
```
